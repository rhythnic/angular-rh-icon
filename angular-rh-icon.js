...
(function (window, angular, undefined) {
   ...
   *        rhIconListProvider.setFilePath('assets/icons.json');
   *
  ...
  .directive('rhDef', function () {
    return {
      restrict: 'EA',
      replace: true,
      template: ['<svg style="display:none"><defs>',
                 '<symbol ng-repeat="id in iconIDs" rh-viewbox="{{icons[id].viewBox}}" id="{{id}}">',
                 '<path rh-d="{{icons[id].path}}" /></symbol></defs></svg>'].join(''),
      scope: {},
